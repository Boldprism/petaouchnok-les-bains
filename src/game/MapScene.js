...
export default class MapScene extends Phaser.Scene {
  ...
  create() {
    ...
    try {
      ...
      this.cache.tilemap.add('map', { format: TILED_JSON_FORMAT, data: mapJSON });
      const cached = this.cache.tilemap.get('map');
      console.log('[MapScene] cache.tilemap:', cached ? 'OK' : 'NULL');
