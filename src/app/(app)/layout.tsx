...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-[100dvh] max-w-6xl mx-auto bg-bg-nuit">
      {/* Colonne gauche — minimap desktop */}
      {!isMapPage && (
      ...
      {/* Colonne droite — mx-auto UNIQUEMENT sur /map */}
      <div className={`flex-1 min-w-0 flex flex-col h-dvh ${isMapPage ? 'max-w-[430px] md:max-w-none mx-auto md:mx-0' : ''}`}>
